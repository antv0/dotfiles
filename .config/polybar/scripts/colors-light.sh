...
if  [[ $1 = "-default" ]]; then
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #000000/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #080808/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #101010/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #181818/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #202020/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #282828/g' $PDIR/config.ini
sed -i -e 's/shade7 = .*/shade7 = #303030/g' $PDIR/config.ini
sed -i -e 's/shade8 = .*/shade8 = #383838/g' $PDIR/config.ini
sed -i -e 's/accent = .*/accent = #282828/g' $PDIR/config.ini
sed -i -e 's/bground = .*/bground = #404040/g' $PDIR/config.ini
sed -i -e 's/bground-alt = .*/bground-alt = #00000000/g' $PDIR/config.ini
sed -i -e 's/modulefg = .*/modulefg = #ebdbb2/g' $PDIR/config.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = #ebdbb2/g' $PDIR/config.ini
$LAUNCH &
